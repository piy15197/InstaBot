...
# Importing matplotlib,numpy for plotting the graph
import matplotlib.pyplot as plot
import numpy as nup


APP_ACCESS_TOKEN = '1585972300.64eec56.96e801ae5b69452c9b182cd064d2a3f4'
...
def get_post_liked_by_user():
    ...
    if media_list['meta']['code'] == 200:
        ...
        print 'Not able to fetch post liked by user. Try again.'
    ...
    if user_id == None:
        ...
        if user_media['meta']['code'] == 200:
            ...
            if len(user_media['data']):
                ...
                print 'a. Post with Minimum likes\nb. Post with Maximum likes\n c. Post with a certain Caption\nd. Just Recent one'
                option = raw_input('Enter the choice')
...
'''
 function declaration for the recent post liked by your friend
'''
...
'''
function to determine a user's interests based on hashtag analysis of recent posts and plot the same using matplotlib
'''

def search_by_hashtag_and_plot(tag_name):
...
def start_bot():
    while True:
        ...
        print "f.Get recent post liked by your friend\n"
        ...
        print "l.Search and plot the analysis by using hashtag\n"
        print "m.Exit"
        ...
        if choice == "a":
            ...
            tag_name = raw_input('Enter the name of tag for which you want to search and plot analysis ')
            search_by_hashtag_and_plot(tag_name)
        elif choice == "m":
            exit()
